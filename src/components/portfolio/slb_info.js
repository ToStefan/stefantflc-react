...
const SlbInfo = () => {
    return (
        <div class="box container">
            ...
            <img id="snake-img" class="roundedImg" src={require("./../../assets/images/snake.gif")} alt="snake gif" />
            <p><i>You can find <a href="https://github.com/ToStefan/Super-Lazy-Boot" target="_blank" rel="noopener noreferrer"><u>source code</u></a> on my github.</i></p>
        </div>
    );
};
